...
<title>CONDOMINIO 6-26</title>

<script type="text/javascript">
<?php if ($_GET['page']!='view'){ ?>
     alert('Bienvenido 6-26');
	 window.location.replace("https://www.concasa.com/proyectos-626?page=view");
<?php } ?>
</script>
...
<meta property="og:description" content="Condominio 6-26 | Unidades disponibles que van desde los $<?=number_format(getPrecioProperty('626','1'), 0, '.', ',');?> USD*" />
...
<div class="page-content header-clear-small">
	<div class="cover-slider owl-carousel owl-has-dots-over">
		...
		<div class="cover-item" style="background-image:url('/images/pictures_vertical/bg12.jpg');">
			<div class="cover-content cover-content-bottom"> 
				<h2 class="color-concasa center-text uppercase ultrabold top-30"><img class="logo-proyecto" src="/images/l-626-w.png" style="height: 100px !important;width: auto !important;"></h2>
				...
				<p class="color-concasa center-text opacity-70 bottom-0 showdow-new">Desde <b>$<?=number_format(getPrecioProperty('626','1'), 0, '.', ',');?> USD*</b></p>
			</div>
    ...
    <div class="page-content header-clear-small" style="padding-top: 20px !important;">
                ...
                <div class="tab-pill-content">
                    ...
                    <div class="tab-item active-tab" id="tab-pill-1">
	                    ...
	                    <div class="item-price">
                            ...
                            <b>$<?=number_format(getPrecioProperty('626','1'), 0, '.', ',');?></b> 
                            <small>USD*</small>
                        </div>
                        <a href="javascript:void(0);" data-menu="notification-calc" data-valor="<?=getPrecioProperty('626','1')?>" data-inicial="<?=getPrimaProperty('626','1')?>" class="item-couta-a calcular" data-toggle="tooltip" data-placement="top" title="" data-original-title="Click para Calcular su Cuota">
                            <div class="item-couta">$<?=getCuotaProperty('626','1');?> <small>USD*</small></div>
                            <p class="text-center">Cuota mensual aproximada</p>
                        </a>
                        
                        
                        <img src="/images/planos/1.png" alt="Responsive image" style="height: 100%; width: 100%; margin-bottom: 20px;">
                        ...
                        <div class="item-details"><img src="/images/new-mts.png" style="display: inline-block;height: 30px;margin-right: 10px;"><b>78</b> <small>m²</small><p>Área de construcción, distribuidos en las distintas áreas.</p></div> 
                    ...
                    <div class="tab-item active-tab" id="tab-pill-2">
	                    ...
	                    <div class="item-price">
                            <span class="icon-homes"></span>
                            <b>$<?=number_format(getPrecioProperty('626','2'), 0, '.', ',');?></b> 
                            <small>USD*</small>
                        </div>
                        <a href="javascript:void(0);" data-menu="notification-calc" data-valor="<?=getPrecioProperty('626','2')?>" data-inicial="<?=getPrimaProperty('626','2')?>" class="item-couta-a calcular" data-toggle="tooltip" data-placement="top" title="" data-original-title="Click para Calcular su Cuota">
                            <div class="item-couta">$<?=getCuotaProperty('626','2');?> <small>USD*</small></div>
                            <p class="text-center">Cuota mensual aproximada</p>
                        </a>
                        
                        
                        <img src="/images/planos/3.png" alt="Responsive image" style="height: 100%; width: 100%; margin-bottom: 20px;">
                        ...
                        <div class="item-details"><img src="/images/new-duck.png" style="display: inline-block;height: 30px;margin-right: 10px;"><b>2</b> <small>BA&Ntilde;OS</small><p>Baño principal y baño de visitas enchapados con azulejo cerámico y piso de porcelanato.</p></div>
                        <div class="item-details"><img src="/images/new-park.png" style="display: inline-block;height: 30px;margin-right: 10px;"><b>1</b> <small>PARQUEO</small><p>Por apartamento, con opción de solicitar espacio adicional.</p></div>
                        <div class="item-details"><img src="/images/new-mts.png" style="display: inline-block;height: 30px;margin-right: 10px;"><b>94</b> <small>m²</small><p>Área de construcción, distribuidos en las distintas áreas.</p></div>
        ...
        <div class="content">
			...
			<div class="gallery gallery-square gallery-filter gallery-filter-three bottom-0">
				...
				<a href="/proyecto/data2/images/6.jpg" class="show-gallery filtr-item" title="Galeria 6-26" data-category="2">
					<img src="/proyecto/data2/images/6.jpg" alt="Galeria 6-26">
					<span>Galeria 6-26</span>
				</a>
				...
				<a href="/proyecto/data2/images/7.jpg" class="show-gallery filtr-item" title="Galeria 6-26" data-category="2">
					<img src="/proyecto/data2/images/7.jpg" alt="Galeria 6-26">
					<span>Galeria 6-26</span>
				</a>
				<a href="/proyecto/data2/images/8.jpg" class="show-gallery filtr-item" title="Galeria 6-26" data-category="2">
					<img src="/proyecto/data2/images/8.jpg" alt="Galeria 6-26">
					<span>Galeria 6-26</span>
				</a>
				<a href="/proyecto/data2/images/9.jpg" class="show-gallery filtr-item" title="Galeria 6-26" data-category="2">
					<img src="/proyecto/data2/images/9.jpg" alt="Galeria 6-26">
					<span>Galeria 6-26</span>
				</a>
				...
				<a href="/proyecto/data2/images/10.jpg" class="show-gallery filtr-item" title="Galeria 6-26" data-category="2">
					<img src="/proyecto/data2/images/10.jpg" alt="Galeria 6-26">
					<span>Galeria 6-26</span>
				</a>
				<a href="/proyecto/data2/images/11.jpg" class="show-gallery filtr-item" title="Galeria 6-26" data-category="2">
					<img src="/proyecto/data2/images/11.jpg" alt="Galeria 6-26">
					<span>Galeria 6-26</span>
				</a>
			</div>
		</div>
    ...
    <?php include $_SERVER['DOCUMENT_ROOT'].'/fotter-mobile-626.php'; ?>
