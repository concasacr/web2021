<div class="form-widget">
	<div class="row shadow bg-light border">
		<div class="col-lg-4 dark" style="background: url('//cdn.concasa.com/concasa.com/clientes/images/n-images/postventa-2.jpg') center center / cover; min-height: 400px;"></div>
		<div class="col-lg-8 p-5">
			<form action="" method="post" enctype="multipart/form-data" name="myFormZendeskC" id="myFormZendeskC" class="form_group_actions">
			   <input id="project" name="project" type="hidden" value="terrazas_del_norte">
			   <input id="macro" name="macro" type="hidden" value="terrazas_del_norte">
			   ...
			   <div id="contentalerttextnotificationC" class="form-group form-group-lg"></div>
			   <div class="form-group form-group-lg">
			      <div class="row">
