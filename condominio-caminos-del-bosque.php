            ...
            <div class="tab-content" id="pills-tabContent">
               <div class="tab-pane fade show active" id="pills-a" role="tabpanel" aria-labelledby="pills-a-tab">
                  ...
                  <div class="col_two_fifth topmargin-sm col_last" data-animate="fadeInRightBig">
                     <div class="heading-block topmargin">
                        ...
                        <h2 title="Amenidades del condominio, Modelos disponibles, ubicación del condominio"><i class="title-tin-h">Desde</i><i class="pricedolar">$<?=number_format(getPrecioProperty('Bosque','1'), 0, '.', ',');?></i> <i class="priceusd">USD*</i> </h2>
                        <h3><i class="title-tin-h">Cuota mensual aproximada</i><i class="pricecouta">$<?=getCuotaProperty('Bosque','1');?></i> <i class="priceusdcouta">USD*</i></h3>
                     </div>
                  ...
                  <div id="features-plan">
                     <div class="col_one_fourth">
                        <div class="feature-box fbox-small fbox-plain" data-animate="fadeIn">
                           ...
                           <p>Amplio dormitorio principal y un dormitorio secundario.</p>
                        </div>
                     </div>
                     <div class="col_one_fourth">
                        <div class="feature-box fbox-small fbox-plain" data-animate="fadeIn" data-delay="200">
                           ...
                           <h3>1 Baños</h3>
                           <p>Baño, enchapados con azulejo cerámico y piso de porcelanato.</p>
                        </div>
                     </div>
                     <div class="col_one_fourth">
               ...
               <div class="tab-pane fade" id="pills-b" role="tabpanel" aria-labelledby="pills-b-tab">
                  <div class="col_two_fifth topmargin-sm col_last" style="float: left !important; clear: left !important; margin-left: 35px !important;" data-animate="fadeInLeftBig">
                     <div class="heading-block topmargin">
                        <span style="font-size: 20px;">Apartamentos con acabados de primera calidad, amplias habitaciones y espacios personalizables.</span>
                        <h2 title="Amenidades del condominio, Modelos disponibles, ubicación del condominio"><i class="title-tin-h">Desde</i><i class="pricedolar">$<?=number_format(getPrecioProperty('Bosque','2'), 0, '.', ',');?></i> <i class="priceusd">USD*</i> </h2>
                        <h3><i class="title-tin-h">Cuota mensual aproximada</i><i class="pricecouta">$<?=getCuotaProperty('Bosque','2');?></i> <i class="priceusdcouta">USD*</i></h3>
                     </div>
                      <a class="button button-border button-rounded button-large noleftmargin topmargin-sm" data-toggle="modal" data-target=".bs-example-modal-sm">Agendar visita</a>
                      <div class="clear"></div>
                      <a href="#myModal3" class="botonmoreinfo" data-lightbox="inline"><span class="icon-line2-envelope-open"></span> Solicitar información</a>
                  ...
                  <div class="form-group row">
                     <div class="col-12 inputGroupContainer rmcp-input">
                        <div class="input-group"><span class="input-group-addon">Precio</span>
                           <input type="text" name="rmcp_input[1][0]" required="true" id="rmcp_input_1_0" class="rmcp-input-text form-control" placeholder="Valor del Apartamento" value="<?=number_format(getPrecioProperty('Bosque','1'), 0, '.', ',');?>">
                        </div>
                  ...
                  <div class="form-group row">
                     <div class="col-12 inputGroupContainer rmcp-input">
                        <div class="input-group"><span class="input-group-addon">Prima</span>
                           <input type="text" name="rmcp_input[1][1]" required="true" id="rmcp_input_1_1" class="rmcp-input-text form-control" placeholder="Pago Inicial" value="<?=number_format(getPrimaProperty('Bosque','1'), 0, '.', ',');?>">
                        </div>
                        <span class="rmcp-error"></span>
                     </div>
                  </div>
...
<?php include 'other-projects-cb.php'; ?>
...
<div class="modal3 mfp-hide subscribe-widget" id="myModal3">
	<div class="block dark divcenter" style="background: url('./n-images/forms-626.jpg') no-repeat; background-size: cover; max-width: 700px; background-color: #000;" data-height-xl="480">
		<div style="padding: 50px;">
			...
			<form accept-charset="UTF-8" action="https://wx394.infusionsoft.com/app/form/process/a430f512ed2530ae135959ba294da887" class="infusion-form" id="inf_form_a430f512ed2530ae135959ba294da887" method="POST" style="width: 100%;">
		    <input name="inf_form_xid" type="hidden" value="a430f512ed2530ae135959ba294da887" />
		    <input name="inf_form_name" type="hidden" value="Website Form ~br~Caminos del Bosque" />
		    ...
		    <input name="inf_custom_ProyectoInteres" type="hidden" value="Caminos del Bosque" />
			...
			<div class="infusion-field">
				<button class="button button-rounded button-border button-light noleftmargin infusion-recaptcha" id="recaptcha_a430f512ed2530ae135959ba294da887" type="submit" style="margin-top:15px;">Más información</button>
			</div>
...
<script type="text/javascript" src="https://wx394.infusionsoft.com/app/timezone/timezoneInputJs?xid=a430f512ed2530ae135959ba294da887"></script>