...
<div class="one-half first">
   <form method="post" name="rmcp_form" id="rmcp-form-1" class="rmcp-form rmcp-form-responsive rmcp-form-light">
         ...
         <div class="form-group">
            ...
            <div class="col-md-8 inputGroupContainer rmcp-input">
               <div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
                <input type="text" name="rmcp_input[1][0]" required="true" id="rmcp_input_1_0" class="rmcp-input-text form-control" placeholder="$ Ingrese un valor en dolares." value="<?=$_GET['val'];?>">
         ...
         <div class="form-group">
            ...
            <div class="col-md-8 inputGroupContainer rmcp-input">
               <div class="input-group">
                ...
                <input type="text" name="rmcp_input[1][1]" required="true" id="rmcp_input_1_1" class="rmcp-input-text form-control" placeholder="% Debe ingresar un valor porcentual." value="">
                <span class="input-group-addon">.00</span>
               </div>
               <span class="rmcp-error"></span>
            </div>
         ...
         <div class="form-group">
            <label class="col-md-4 control-label">Plazo del Crédito</label>
            <div class="col-md-8 inputGroupContainer rmcp-input">
               <div class="input-group">
                <span class="input-group-addon"><i class="glyphicon glyphicon-time"></i></span>
                <input type="text" name="rmcp_input[1][3]" required="true" id="rmcp_input_1_3" class="rmcp-input-text form-control" placeholder="años" value="<?=$_GET['year'];?>">
               </div>
               <span class="rmcp-error"></span>
            </div>
         </div>
        ...
        "1": {
            "interface": {
                "elements": [{
                    ...
                    "rank": 5,
                    "label": "Results",
                    "content": "<div id=\"div_bancos\"><h5 class=\"text-center negrita\">Cuota mensual aproximada<\/h5><h2 class=\"text-center\">$&nbsp;{mpc_payment_result}<\/h2><h6 class=\"negrita text-center pt-2\">Ingreso mínimo: <span>${mpc_min_salary}<\/span><\/h6><p class=\"text-center p-3\"><small> *Los siguientes son cálculos aproximados<\/small><\/p><\/div>",
                    "annual_payment_text": "",
