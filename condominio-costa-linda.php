      ...
      <div class="row clearfix">
         <div class="col-xl-5" data-animate="bounceInLeft" data-delay="50">
            <div class="heading-block topmargin-sm">
               <h1 title="Condominio Costa Linda - Su Hogar en Playa Jacó﻿"><small>Bienvenido </small>a Costa Linda</h1>
            </div>
            <p class="lead">Condominio Costa Linda ofrece cómodos apartamentos construidos con acabados de primera calidad, rodeados de amplias áreas verdes con árboles nativos, área de piscina y espacios para disfrutar la calidez de la costa del Pacífico de Costa Rica.</p>
         </div>
         <div class="col-xl-7">
            <div>
         ...
         <div class="row show-grid">
            ...
            <div class="col-lg-3" data-animate="fadeIn" data-delay="300">
               <div class="col-padding-concasa ohidden">
                  ...
                  <p>Amplio deck alrededor del área de piscina con hermosas vistas hacia el proyecto.</p>
               </div>
            </div>
            <div class="clear"></div>
               ...
               <div class="tab-pane fade show active" id="pills-a" role="tabpanel" aria-labelledby="pills-a-tab">
                  ...
                  <div class="col_two_fifth topmargin-sm col_last" data-animate="fadeInRightBig">
                     <div class="heading-block topmargin">
                        ...
                        <h2 title="Amenidades del condominio, Modelos disponibles, ubicación del condominio﻿"><i class="title-tin-h">Desde</i><i class="pricedolar">$<?=number_format(getPrecioProperty('Costa','1'), 0, '.', ',');?></i> <i class="priceusd">USD*</i> </h2>
                        <h3><i class="title-tin-h">Cuota mensual aproximada</i><i class="pricecouta">$<?=getCuotaProperty('Costa','1');?></i> <i class="priceusdcouta">USD*</i></h3>
                     </div>
                  ...
                  <div id="features-plan">
                     <div class="col_one_fourth">
                        <div class="feature-box fbox-small fbox-plain" data-animate="fadeIn">
                           ...
                           <p>Amplio cuarto principal y cuarto de visitas.</p>
                        </div>
                     </div>
                     <div class="col_one_fourth">
                  ...
                  <div class="form-group row">
                     <div class="col-12 inputGroupContainer rmcp-input">
                        <div class="input-group"><span class="input-group-addon">Precio</span>
                           <input type="text" name="rmcp_input[1][0]" required="true" id="rmcp_input_1_0" class="rmcp-input-text form-control" placeholder="Valor del Apartamento" value="<?=number_format(getPrecioProperty('Costa','1'), 0, '.', ',');?>">
                        </div>
                  ...
                  <div class="form-group row">
                     <div class="col-12 inputGroupContainer rmcp-input">
                        <div class="input-group"><span class="input-group-addon">Prima</span>
                           <input type="text" name="rmcp_input[1][1]" required="true" id="rmcp_input_1_1" class="rmcp-input-text form-control" placeholder="Pago Inicial" value="<?=number_format(getPrimaProperty('Costa','1'), 0, '.', ',');?>">
                        </div>
                        <span class="rmcp-error"></span>
                     </div>
                  </div>
...
<?php include 'other-projects-cl.php'; ?>
...
<div class="modal3 mfp-hide subscribe-widget" id="myModal3">
	<div class="block dark divcenter" style="background: url('./n-images/forms-626.jpg') no-repeat; background-size: cover; max-width: 700px; background-color: #000;" data-height-xl="480">
		<div style="padding: 50px;">
			...
			<form accept-charset="UTF-8" action="https://wx394.infusionsoft.com/app/form/process/58e0c3101b6279491164a28a1ab1d0ff" class="infusion-form" id="inf_form_58e0c3101b6279491164a28a1ab1d0ff" method="POST" style="width: 100%;">
		    <input name="inf_form_xid" type="hidden" value="58e0c3101b6279491164a28a1ab1d0ff" />
    <input name="inf_form_name" type="hidden" value="Website Form ~br~Costa Linda" />
    ...
    <input name="inf_custom_ProyectoInteres" type="hidden" value="Costa Linda" />
    ...
    <input name="inf_field_Country" type="hidden" value="Costa Rica" />
			...
			<div class="infusion-field">
				<button class="button button-rounded button-border button-light noleftmargin infusion-recaptcha" id="recaptcha_58e0c3101b6279491164a28a1ab1d0ff" type="submit" style="margin-top:15px;">Más información</button>
			</div>
...
<script type="text/javascript" src="https://wx394.infusionsoft.com/app/timezone/timezoneInputJs?xid=58e0c3101b6279491164a28a1ab1d0ff"></script>