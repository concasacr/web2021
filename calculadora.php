...
.input-group {
    border-bottom: 1px solid #093037;
}
.select {
    border-bottom: 1px solid #093037 !important;
}
.logo-top {
    width: 70%;
    margin: 0 auto;
...
ul.social-fotter li a {
    color: #535353;
}

ul.social-fotter li a:hover {
    color: #4294df;
}
video#myVideo {
    width: 100%;
...
#form1-mobiledesktop {
	-webkit-box-shadow: 1px 1px 6px 1px #DBDBDB;
...
<script type="text/javascript" id="hs-script-loader" async defer src="//js.hs-scripts.com/8253184.js"></script>
<!-- End of HubSpot Embed Code -->

</head>
  <body style="color: #363636; padding-top: 30px;"><!-- background: #dbdee2; -->
...
<!-- <header role="banner" class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        ...
        <div class="navbar-default side-collapse in" style="border-left: 1px solid #e7e7e7;">
	...
	<img src="../images/logo-b.svg" alt="Logo Concasa" class="logo-top" />  
	  
	  
<p style="text-align: center;padding: 20px;font-weight: bold;">Aquí podés averiguar la cuota aproximada de tu casa o apartamento.</br>
Si tenés dudas podés escribirnos o agendar una cita con uno de nuestros asesores.</p>
         ...
         <div class="form-group">
            ...
            <div class="col-md-8 inputGroupContainer rmcp-input">
               <div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
                <input type="text" name="rmcp_input[1][0]" required="true" id="rmcp_input_1_0" class="rmcp-input-text form-control number" placeholder="Ingrese el valor de la propiedad" value="" required>
         ...
         <div class="form-group">
            ...
            <div class="col-md-8 inputGroupContainer rmcp-input">
               <div class="input-group">
                ...
                <input type="text" name="rmcp_input[1][1]" required="true" id="rmcp_input_1_1" class="rmcp-input-text form-control numbers" placeholder="Valor de la prima" value="" required>
                <span class="input-group-addon">.00</span>
               </div>
               <span class="rmcp-error"></span>
            </div>
         ...
         <div class="form-group">
            ...
            <div class="col-md-8 inputGroupContainer rmcp-input">
               <div class="select-group">
                ...
                <option value="7.95">7.00% - $ BAC San José</option>
         ...
         <div class="form-group">
            ...
            <div class="col-md-8 inputGroupContainer rmcp-input">
               <div class="input-group">
                ...
                <input type="number" name="rmcp_input[1][3]" required="true" id="rmcp_input_1_3" class="rmcp-input-text form-control" placeholder="Numero de años" value="" required>
               </div>
               <span class="rmcp-error"></span>
            </div>
         </div>
...
<div id="form2-mobiledesktop">
   ...
   <div class="container" style="margin-top: 20px;">
	   ...
	   <div class="row">
		  <div class="col-xs-6"><a onclick="Calendly.showPopupWidget('https://calendly.com/fonchog');return false;" class="protected-btn a-btn-2 creative anima"><span class="a-btn-line"></span>+ <span class="mobile">Cita</span><span class="desktop">Agenda tu cita con un Asesor</span></a></div>
		  <div class="col-xs-6"><a href="https://concasa.com/" class="protected-btn a-btn-2 creative anima"><span class="a-btn-line"></span><span class="mobile">Website</span><span class="desktop">Ver Website</span></a></div>
		</div>
...
<script type="text/javascript">
//document.document.forms["rmcp_form"].submit();
...
//$(document).ready(function() {   
 /*  
	...
	numbers.addEventListener('keyup', (e) => {
		const element = e.target;
		const value = element.value;
	  element.value = formatNumbers(value);
	});
