	  <nav id="menu-principal" class="navbar navbar-expand-sm navbar-dark">
	        <a class="navbar-brand" href="/"> <img src="/images/logo-b.svg" width="auto" height="30" alt="LOGO CONCASA"> </a>
	        ...
	        <div class="collapse navbar-collapse" id="navbarsExample09">
	          <ul class="navbar-nav ml-auto">
	           ...
	           <li class="nav-item dropdown">
	              <a class="nav-link dropdown-toggle" href="javascript:void(0);" id="dropdown19" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="c-icons-network-black"></i></a>
	            ...
	            <li class="nav-item dropdown">
	              <a class="nav-link dropdown-toggle" href="javascript:void(0);" id="dropdown19" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="/001-costa-rica.svg" width="14" alt="CONCASA COSTA RICA"></a>
