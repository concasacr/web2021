...
<head>
    <meta http-equiv="content-type" content="text/html; charset=utf-8" />
		...
		<meta name="author" content="Condominio Caoba - Su condominio en Cuidad Colón - Concasa﻿" />
		<meta name="description" content="Condominio de Townhouse en Cuidad Colón. Conozca su futuro hogar en nuestro espectacular condominio"/>
		<meta property="og:description" content="Condominio de Townhouse en Cuidad Colón. Conozca su futuro hogar en nuestro espectacular condominio" />
		<meta name="keywords"  content="condominios en costa rica, condominioes en costa rica, Condominios en Cuidad Colón, Condominio Caoba﻿" />
...
<section id="page-title" class="page-title-parallax page-title-dark page-title-right dark" style="padding: 450px 0; background-image: url('//cdn.concasa.com/concasa.com/images/n-images/proyectos/ccb/imgp-ccb.jpg'); background-size: cover; background-position: center center;" data-bottom-top="background-position:0px 440px;" data-top-bottom="background-position:0px -500px;">
	...
	<div class="container clearfix text-left-int" data-animate="bounceInLeft" data-delay="50">
		...
		<h1 title="Condominio  Caoba - Su Hogar en Alajuela﻿">Caoba</h1>
		<span>Cuidad Colón</span>
	</div>
      ...
      <div class="row clearfix">
         <div class="col-xl-5" data-animate="bounceInLeft" data-delay="50">
            <div class="heading-block topmargin-sm">
               <h1 title="Condominio  Caoba - Su Hogar en Alajuela﻿"><small>Bienvenido </small>a Caoba</h1>
            </div>
            <p class="lead">Condominio Caoba ofrece espaciosos townhouses con acabados de primera calidad rodeados de amplias áreas verdes, un delicioso clima, casa club, área de piscina y otras amenidades  para disfrutar.</p>
         </div>
         <div class="col-xl-7">
            <div>
         ...
         <div class="row show-grid">
            ...
            <div class="col-lg-3" data-animate="fadeIn" data-delay="300">
               <div class="col-padding-concasa ohidden">
                  ...
                  <p>El proyecto tiene espacios dedicados al deporte, como en las canchas multiuso para jugar fútbol y básquetbol, la cancha tenis, la pista de trote y los 2,4 Km de acera que rodean el macro condominio.</p>
               </div>
            </div>
            <div class="clear"></div>
      ...
      <div class="content-wrap-concasa">
         <div class="container clearfix">
            <ul class="nav nav-pills mb-3 top30" id="pills-tab" role="tablist">
               <li class="nav-item">
                  <a class="nav-link active" id="pills-a-tab" data-toggle="pill" href="#pills-a" role="tab" aria-controls="pills-a" aria-selected="true">Primera Planta</a>
               </li>
              <li class="nav-item">
                  <a class="nav-link" id="pills-b-tab" data-toggle="pill" href="#pills-b" role="tab" aria-controls="pills-b" aria-selected="false">Segunda Planta</a>
               </li>
            </ul>
            <div class="tab-content" id="pills-tabContent">
               <div class="tab-pane fade show active" id="pills-a" role="tabpanel" aria-labelledby="pills-a-tab">
                  ...
                  <div class="col_two_fifth topmargin-sm col_last" data-animate="fadeInRightBig">
                     <div class="heading-block topmargin">
                        <span style="font-size: 20px;">Townhouse con acabados de primera calidad, amplias habitaciones y espacios personalizables..</span>
                        <h2 title="Amenidades del condominio, Modelos disponibles, ubicación del condominio"><i class="title-tin-h">Desde</i><i class="pricedolar">$<?=number_format(getPrecioProperty('Caoba','1'), 0, '.', ',');?></i> <i class="priceusd">USD*</i> </h2>
                       <!-- <h3><i class="title-tin-h">Cuota mensual aproximada</i><i class="pricecouta">$<?=getCuotaProperty('Caoba','1');?></i> <i class="priceusdcouta">USD*</i></h3>-->
                     </div>
                  ...
                  <div id="features-plan">
                     ...
                     <div class="col_one_fourth">
                        <div class="feature-box fbox-small fbox-plain" data-animate="fadeIn" data-delay="200">
                           ...
                           <h3>2 <sup>1</sup>/<sub>2</sub> Baños</h3>
                           <p>Baño principal, baño habitación principal y baño de visitas, enchapados con azulejo cerámico y piso de porcelanato.</p>
                        </div>
                     </div>
                     <div class="col_one_fourth">
                        <div class="feature-box fbox-small fbox-plain" data-animate="fadeIn" data-delay="400">
                           ...
                           <h3>Parqueo</h3>
                           <p>Dos por casa, con opción de solicitar espacio adicional.</p>
                        </div>
                     </div>
               ...
               <div class="tab-pane fade" id="pills-b" role="tabpanel" aria-labelledby="pills-b-tab">
                  <div class="col_two_fifth topmargin-sm col_last" style="float: left !important; clear: left !important; margin-left: 35px !important;" data-animate="fadeInLeftBig">
                     <div class="heading-block topmargin">
                        <span style="font-size: 20px;">Casas tipo townhouse con acabados de primera calidad, amplias habitaciones y espacios personalizables.</span>
                        <h2 title="Amenidades del condominio, Modelos disponibles, ubicación del condominio"><i class="title-tin-h">Desde</i><i class="pricedolar">$<?=number_format(getPrecioProperty('Caoba','2'), 0, '.', ',');?></i> <i class="priceusd">USD*</i> </h2>
                        <!--<h3><i class="title-tin-h">Cuota mensual aproximada</i><i class="pricecouta">$<?=getCuotaProperty('Caoba','2');?></i> <i class="priceusdcouta">USD*</i></h3>-->
                     </div>
                      <a class="button button-border button-rounded button-large noleftmargin topmargin-sm" data-toggle="modal" data-target=".bs-example-modal-sm">Agendar visita</a>
                      <div class="clear"></div>
                      <a href="#myModal3" class="botonmoreinfo" data-lightbox="inline"><span class="icon-line2-envelope-open"></span> Solicitar información</a>
...
<section id="section-gallery" class="page-section">
	<div class="content-wrap">
		<div class="heading-block center">
			<h2 title="Amenidades del condominio, Modelos disponibles, ubicación del condominio">Galería <span>Caoba</span></h2>
                  ...
                  <div class="form-group row">
                     <div class="col-12 inputGroupContainer rmcp-input">
                        <div class="input-group"><span class="input-group-addon">Precio</span>
                           <input type="text" name="rmcp_input[1][0]" required="true" id="rmcp_input_1_0" class="rmcp-input-text form-control" placeholder="Valor del Apartamento" value="<?=number_format(getPrecioProperty('Caoba','1'), 0, '.', ',');?>">
                        </div>
                  ...
                  <div class="form-group row">
                     <div class="col-12 inputGroupContainer rmcp-input">
                        <div class="input-group"><span class="input-group-addon">Prima</span>
                           <input type="text" name="rmcp_input[1][1]" required="true" id="rmcp_input_1_1" class="rmcp-input-text form-control" placeholder="Pago Inicial" value="<?=number_format(getPrimaProperty('Caoba','1'), 0, '.', ',');?>">
                        </div>
                        <span class="rmcp-error"></span>
                     </div>
                  </div>
...
<?php include 'other-projects-ccb.php'; ?>
